...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(120.2,16.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ27, new cjs.Rectangle(0.1,0,240.4,32.6), null);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(61.4,12.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(0,0,122.8,24.9), null);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-18,112);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ17, new cjs.Rectangle(-18,112,341,198), null);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-87,0,1.537,2.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(-87,0,498,600), null);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(181,285.9,1,3.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ10, new cjs.Rectangle(0,104,362,363.9), null);
...
p.nominalBounds = new cjs.Rectangle(-24.3,-22.2,240.5,81.9);
...
}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-37,41.7,148.9,237), null);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(217,117,0.792,0.792,0,0,0,287.9,125);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-11,18,283.7,278.7), null);
...
p.nominalBounds = new cjs.Rectangle(-18,112,341,198);
...
// stage content:
(lib.DallasZoo_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.3,301.3,0.913,0.913,0,0,0,115.3,115.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(11).to({regX:115.4,regY:115.5,scaleX:0.55,scaleY:0.55,x:150,y:520.6},19,cjs.Ease.get(-0.27)).wait(103));

	// Слой 18
	this.instance_2 = new lib.Символ23();
	this.instance_2.parent = this;
	this.instance_2.setTransform(151.5,387.3,1,1,0,0,0,97.5,12.3);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(149.7,317.6,1.793,1.793,0,0,0,73.2,20);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(146.1,545.5,1,1,0,0,0,181,49.5);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(224.2,156.5,1.498,1.498);
	this.instance_5.alpha = 0.379;

	this.instance_6 = new lib.Символ20();
	this.instance_6.parent = this;
	this.instance_6.setTransform(209,211.7,1.498,1.498);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(288.4,227.8,1.498,1.498);
	this.instance_7.alpha = 0.379;

	this.instance_8 = new lib.Символ20();
	this.instance_8.parent = this;
	this.instance_8.setTransform(157.4,211.7,1.498,1.498);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(252.5,78.3,1.291,1.291);
	this.instance_9.alpha = 0.379;

	this.instance_10 = new lib.Символ20();
	this.instance_10.parent = this;
	this.instance_10.setTransform(173.1,74.5,1.291,1.291);
	...
	this.instance_12.parent = this;
	this.instance_12.setTransform(609.1,103.5,1.285,1.285,0,0,0,228.1,98.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(11).to({scaleX:0.72,scaleY:0.72,x:-25.4,y:89.4},37,cjs.Ease.get(0.35)).wait(86));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(52,299,498,602);
// library properties:
lib.properties = {

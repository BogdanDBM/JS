...
(lib.bgOver = function() {
	this.initialize(img.bgOver);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,369,90);
...
p.nominalBounds = new cjs.Rectangle(0,0,576,250);


(lib.shark = function() {
	this.initialize(img.shark);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,557,250);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(64.7,8.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ27, new cjs.Rectangle(0,0,129.4,17.5), null);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(33.8,6.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(0,0,67.7,13.7), null);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(70.3,10.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ24, new cjs.Rectangle(0,0,140.7,20.2), null);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-111,-50,1.049,1.049);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ17, new cjs.Rectangle(-111,-50,584.5,262.4), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(-15,0,157,250), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ13, new cjs.Rectangle(0,0,576,250), null);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,-67,2.315,0.892);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(0,-67,750,223), null);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.instance = new lib.bgOver();
	this.instance.parent = this;
	this.instance.setTransform(35,-172);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ10, new cjs.Rectangle(0.5,-176.5,456.5,99), null);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(36.1,35.2,1,1,0,0,0,64.7,8.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(14).to({_off:false,regX:64.6,regY:8.8,scaleX:1.31,scaleY:1.31,x:36,y:35.3,alpha:0},0).to({regX:64.7,regY:8.7,scaleX:1,scaleY:1,x:36.1,y:35.2,alpha:1},23,cjs.Ease.backInOut).wait(8));

	// Символ 26
	this.instance_1 = new lib.Символ26();
	this.instance_1.parent = this;
	this.instance_1.setTransform(35.6,12.6,1,1,0,0,0,33.8,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(1).to({_off:false,scaleX:1.5,scaleY:1.5,alpha:0},0).to({scaleX:1,scaleY:1,alpha:1},23,cjs.Ease.backInOut).wait(21));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31,-1,223.8,47.7);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(41).call(this.frame_41).wait(20));

	// Слой 2
	this.instance = new lib.Символ24();
	this.instance.parent = this;
	this.instance.setTransform(73.6,20.1,1,1,0,0,0,70.3,10.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(1).to({_off:false,regX:70.2,regY:10.2,scaleX:1.9,scaleY:1.9,x:73.4,y:20.4,alpha:0},0).to({regX:70.3,regY:10.1,scaleX:1,scaleY:1,x:73.6,y:20.1,alpha:1},28,cjs.Ease.backInOut).wait(31));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,146.3,40.1);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(105,61.2,0.493,0.493,0,0,0,71.8,100.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(62.2,11.8,77.5,123.3), null);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(479,27.5,0.684,0.684,0,0,0,287.9,125);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(282,-58,394,171.1), null);
...
p.nominalBounds = new cjs.Rectangle(-111,-50,584.5,262.4);
...
// stage content:
(lib.DallasZoo_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(364.1,45.1,0.384,0.384,0,0,0,115.4,115.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(18).to({regX:115.5,regY:115.5,scaleX:0.33,scaleY:0.33,x:50.6,y:45.3},40,cjs.Ease.quartInOut).wait(75));

	// Слой 18
	this.instance_2 = new lib.Символ23();
	this.instance_2.parent = this;
	this.instance_2.setTransform(235.2,52.8,1,1,0,0,0,97.5,12.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(67).to({_off:false},0).wait(67));

	// Слой 17
	this.instance_3 = new lib.Символ22();
	this.instance_3.parent = this;
	this.instance_3.setTransform(178.7,24.1,1.188,1.188,0,0,0,73.2,19.9);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(239.2,174.7,1,1,0,0,0,60.5,96.4);
	this.instance_4.alpha = 0.5;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(42).to({_off:false},0).to({x:328.7,y:84.6,alpha:1},27,cjs.Ease.quadOut).wait(65));

	// Слой 6
	this.instance_5 = new lib.Символ10();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-33,222,1,1,0,0,0,181,49.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({_off:false},0).to({x:146.1,alpha:1},29).wait(86));

	// boubles
	this.instance_6 = new lib.Символ20();
	this.instance_6.parent = this;
	this.instance_6.setTransform(621.8,53.5);
	this.instance_6.alpha = 0.379;

	this.instance_7 = new lib.Символ20();
	this.instance_7.parent = this;
	this.instance_7.setTransform(442.3,53.5);
	this.instance_7.alpha = 0.379;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.instance_6}]},82).to({state:[]},31).wait(21));

	// boubles
	this.instance_8 = new lib.Символ20();
	this.instance_8.parent = this;
	this.instance_8.setTransform(587.3,52.2);
	this.instance_8.alpha = 0.379;

	this.instance_9 = new lib.Символ20();
	this.instance_9.parent = this;
	this.instance_9.setTransform(496.8,48);
	this.instance_9.alpha = 0.379;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9},{t:this.instance_8}]},58).to({state:[]},55).wait(21));

	// boubles
	this.instance_10 = new lib.Символ20();
	this.instance_10.parent = this;
	this.instance_10.setTransform(699.6,65.7);
	this.instance_10.alpha = 0.379;

	this.instance_11 = new lib.Символ20();
	this.instance_11.parent = this;
	this.instance_11.setTransform(612.1,48);
	this.instance_11.alpha = 0.379;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11},{t:this.instance_10}]},42).to({state:[]},71).wait(21));

	// Слой 10
	this.instance_12 = new lib.Символ18();
	this.instance_12.parent = this;
	this.instance_12.setTransform(528,42.6,1,1,0,0,0,19,19.3);
	this.instance_12.alpha = 0.5;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(42).to({_off:false},0).to({_off:true},71).wait(21));

	// shark
	this.shark = new lib.Символ12();
	this.shark.parent = this;
	this.shark.setTransform(906.1,60,0.57,0.57,-9.9,0,0,189.2,90.4);
	this.shark._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shark).wait(42).to({_off:false},0).to({regX:189,regY:90.3,rotation:0,x:621.9,y:51.5},68,cjs.Ease.quadInOut).wait(24));

	// Слой 8
	this.instance_13 = new lib.Символ14();
	this.instance_13.parent = this;
	this.instance_13.setTransform(659.7,103.5,1.285,1.285,0,0,0,228.1,98.9);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(19).to({_off:false},0).to({regX:228,regY:99,scaleX:1,scaleY:1,x:367,y:79.1},29,cjs.Ease.get(0.35)).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(134));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(353,-21,750,223);
// library properties:
lib.properties = {

...
p.nominalBounds = new cjs.Rectangle(0,0,377,180);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(95.7,8.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ25, new cjs.Rectangle(0,0,191.3,16.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ17, new cjs.Rectangle(0,0,377,180), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(0,0,324,250), null);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#405885").s().p("A8RHvIAAvdMA4jAAAIAAPdg");
	this.shape.setTransform(181,49.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ10, new cjs.Rectangle(0,0,362,99), null);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(97.1,14.1,1,1,0,0,0,95.7,8.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(1).to({_off:false,regY:8.2,scaleX:1.35,scaleY:1.35,x:97.2,y:14.3,alpha:0},0).to({regY:8.1,scaleX:1,scaleY:1,x:97.1,y:14.1,alpha:1},23,cjs.Ease.backInOut).wait(21));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,194.9,24.7);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(66.8,77.2,0.771,0.771,0,0,0,71.6,100.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(0,0,121.1,192.8), null);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(228,114,0.792,0.792,0,0,0,287.9,125);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(0,15,456.1,198), null);
...
// stage content:
(lib.DallasZoo_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.3,126.3,0.913,0.913,0,0,0,115.3,115.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(18).to({regY:115.5,scaleX:0.29,scaleY:0.29,x:257,y:211.4},19,cjs.Ease.get(-0.27)).wait(96));

	// Слой 18
	this.instance_2 = new lib.Символ23();
	this.instance_2.parent = this;
	this.instance_2.setTransform(111,225.3,1,1,0,0,0,97.5,12.3);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(114.2,199.6,1,1,0,0,0,73.2,20);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(146.1,300.5,1,1,0,0,0,181,49.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({_off:false},0).to({y:222},29,cjs.Ease.get(0.99)).wait(86));

	// boubles
	this.instance_5 = new lib.Символ20();
	this.instance_5.parent = this;
	this.instance_5.setTransform(291.8,145.7);
	this.instance_5.alpha = 0.379;

	this.instance_6 = new lib.Символ20();
	this.instance_6.parent = this;
	this.instance_6.setTransform(204.3,135);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(257.3,145.7);
	this.instance_7.alpha = 0.379;

	this.instance_8 = new lib.Символ20();
	this.instance_8.parent = this;
	this.instance_8.setTransform(169.8,135);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(291.8,145.7);
	this.instance_9.alpha = 0.379;

	this.instance_10 = new lib.Символ20();
	this.instance_10.parent = this;
	this.instance_10.setTransform(204.3,135);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(198,144.3,1,1,0,0,0,19,19.3);
	...
	this.shark.setTransform(412.3,130.1,0.57,0.57,-5.7,0,0,189.1,90.3);
	...
	this.instance_12.parent = this;
	this.instance_12.setTransform(594.1,103.5,1.285,1.285,0,0,0,228.1,98.9);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(19).to({_off:false},0).to({regX:228,regY:99,scaleX:1,scaleY:1,x:367,y:79.1},29,cjs.Ease.get(0.35)).wait(86));

	// Слой 9
	this.instance_13 = new lib.Символ16();
	this.instance_13.parent = this;
	this.instance_13.setTransform(-63.8,96.4,1,1,0,0,0,60.5,96.4);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(41).to({_off:false},0).to({x:53.7,y:96.6},24,cjs.Ease.quadOut).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(19).to({scaleX:0.72,scaleY:0.72,x:33.6,y:91.4},29,cjs.Ease.get(0.35)).wait(86));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(139,124,324,252);
// library properties:
lib.properties = {
